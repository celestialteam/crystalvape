...
1. Deleting the crystalvape folder (WITH THE GAME CLOSED).
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/celestialteam/crystalvape/refs/heads/main/NewMainScript.lua)
3. Ensuring no external script is conflicting with vape.

## Developers & Credits
[7GrandDad](https://github.com/celestialteam) - Lead maintainer of the project - vaperoblox on Discord
<br/>
