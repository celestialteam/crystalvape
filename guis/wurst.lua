...
local getcustomassets = {
	['crystalvape/assets/wurst/triangle.png'] = 'rbxasset://wurst/triangle.png'
}
...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/celestialteam/crystalvape/'..readfile('crystalvape/profiles/commit.txt')..'/'..select(1, path:gsub('crystalvape/', '')), true) end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		triangle.Image = getcustomasset('crystalvape/assets/wurst/triangle.png')
